    ...
    if i = 0 then
      ...
      for j = 0 to 8 do
        if j <> 0 then (
          ...
          else if (i = 18 || i = 4) && j = 5 then print_string "\027[33m \\ \027[0m"
          else if (i = 16 || i = 2) && j = 4 then print_string "\027[33m \\ \027[0m"
          else if (i = 16 || i = 2) && j = 5 then print_string "\027[33m / \027[0m"
          else print_string "   ";
          if j = 8 then (
            print_char '|';
            print_char '\n'))
